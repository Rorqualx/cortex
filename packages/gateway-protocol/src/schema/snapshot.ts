...
export const PresenceEventSchema = closedObject({
  presence: Type.Array(PresenceEntrySchema),
});

/** Version metadata describing an available OpenClaw update. */
export const UpdateAvailableDataSchema = closedObject({
...
export const UpdateAvailableEventSchema = closedObject({
  updateAvailable: Type.Union([UpdateAvailableDataSchema, Type.Null()]),
});

export const HealthSnapshotSchema = closedObject({
...
export type UpdateAvailableEvent = Static<typeof UpdateAvailableEventSchema>;
