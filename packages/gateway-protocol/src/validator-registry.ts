...
// Fork-owned surfaces (activity, vault, agents.composePrompt). Their schema
// modules live in the same barrel, so they follow the compile(S.X) form above.
export const validateActivityListParams = compile<ActivityListParams>(S.ActivityListParamsSchema);
export const validateActivitySubscribeParams = compile<ActivitySubscribeParams>(
  S.ActivitySubscribeParamsSchema,
);
export const validateActivityUnsubscribeParams = compile<ActivityUnsubscribeParams>(
  S.ActivityUnsubscribeParamsSchema,
);
export const validateVaultListParams = compile<VaultListParams>(S.VaultListParamsSchema);
export const validateVaultSaveParams = compile<VaultSaveParams>(S.VaultSaveParamsSchema);
export const validateVaultDeleteParams = compile<VaultDeleteParams>(S.VaultDeleteParamsSchema);
export const validateAgentsComposePromptParams = compile(S.AgentsComposePromptParamsSchema);
