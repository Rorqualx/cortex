...
| ------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------- |
| `skills.forge.autonomous.mode`  | `"auto"` | Chooses capture behavior; `auto` also enables weekly collection review.                                           |
...
| `skills.forge.maxPending`       | `50`     | Caps pending and quarantined proposals per agent.                                                                 |
