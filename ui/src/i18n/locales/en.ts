...
export const en: TranslationMap = {
  ...
  lazyView: {
    ...
    errorSubtitle: "Something went wrong while loading this panel.",
  ...
  agents: {
    ...
    channels: {
      ...
      fieldLastInbound: "Last inbound",
      fieldLastOutbound: "Last outbound",
      fieldLastConnected: "Last connected",
      fieldReconnects: "Reconnects",
  ...
  subtitles: {
    ...
    activity: "Live cross-agent activity feed.",
  ...
  chat: {
    ...
    toolCards: {
      ...
      widgetExportHtmlFallback:
        "Exported the raw HTML instead — this widget can't be rendered to an image.",
      openFile: "Open file",
  ...
  cron: {
    ...
    jobList: {
      ...
      remove: "Remove",
      run: "Run",
      selectJob: "Select an automation",
      clone: "Clone",
      disable: "Disable",
      enabled: "Enabled",
      history: "History",
    ...
    quickCreate: {
      title: "Quick create",
      defaultName: "Quick automation",
      whatHeading: "What should it do?",
      whatHint: "Describe the task OpenClaw should run on a schedule.",
      promptPlaceholder: "e.g. Summarize unread channels and post a digest",
      nameOptional: "Name (optional)",
      namePlaceholder: "e.g. Morning digest",
      whenHeading: "When should it run?",
      whenHint: "Pick a schedule preset.",
      howHeading: "How should it run?",
      howHint: "Choose how the run is delivered.",
    },
    tabs: {
    ...
    jobs: {
      ...
      loading: "Loading…",
      noMatching: "No automations match the current filters.",
      searchJobs: "Search automations",
      searchPlaceholder: "Search automations",
      subtitle: "Scheduled tasks and recurring agent runs.",
      title: "Automations",
      emptyFilteredHint: "Change the view, search, priority, agent, or archive filter.",
      enabled: "Enabled",
      shownOf: "{shown} of {total}",
    ...
    runs: {
      allJobs: "All automations",
      selectJobHint: "Select an automation to see its run history.",
      selectedJob: "Automation",
      subtitleAll: "Recent runs across all automations.",
      subtitleJob: "Runs for {title}",
      title: "Run history",
      scope: "Scope",
    ...
    form: {
      ...
      basics: "Basics",
      basicsSub: "Name, description, and agent.",
      createSubtitle: "Schedule a new automation.",
      deliverySub: "Where run results are sent.",
      editJob: "Edit automation",
      execution: "Execution",
      executionSub: "How and where the automation runs.",
      isolated: "Isolated",
      jitterHelp:
        "Jitter adds a small random delay to each run so scheduled automations don't all fire at once.",
      main: "Main",
      newJob: "New automation",
      payloadKind: "Payload",
      resultDelivery: "Result delivery",
      scheduleSub: "When the automation runs.",
      session: "Session",
      updateSubtitle: "Update this automation's schedule and delivery.",
      deliverySection: "Delivery",
      schedule: "Schedule",
      required: "Required",
      requiredSr: "required",
  ...
  rsil: {
    title: "Recursive Self-Improvement Laboratory",
    ...
    stage: "Stage",
    discuss: "Discuss",
    discussHint: "Open a chat with this card's context loaded",
    refresh: "Refresh",
    ...
    category: {
      ...
      "queue-guidance": "Queue for Guidance",
    ...
    cardCommit: "Commit",
    cardSource: "Source",
    cardNextSteps: "Next steps",
    moveTo: "Move to",
    assignTo: "Assign to",
    detailTitle: "Item details",
    detailSummary: "Summary",
    detailRelevance: "Integration relevance",
    detailAnalysis: "Analysis",
    detailImplementation: "Implementation",
    detailNextSteps: "Next steps",
    detailAddStep: "Add step",
    detailSave: "Save",
    detailSaved: "Saved.",
    detailSourcePaper: "Source paper",
    detailCycle: "Cycle",
    detailOutcome: "Outcome",
    openReport: "Open cycle report",
  },
  conversations: {
    ...
    emptyNone: "Start chatting to create conversations.",
    emptyFiltered: "No conversations match your filters.",
    countOne: "conversation",
    countOther: "conversations",
  ...
  overview: {
    ...
    auth: {
      failed: "Authentication failed. Run {command} to get a tokenized URL.",
      required: "This gateway requires authentication.",
    },
    eventLog: {
      title: "Event log",
    },
    insecure: {
      hint: "This page isn't a secure context, so the browser blocks the gateway connection. Open the dashboard from {url} instead.",
      stayHttp: "To keep using plain HTTP, set {config} in your gateway config.",
    },
    logTail: {
      title: "Logs",
    },
    pairing: {
      hint: "Pair a device",
      mobileHint: "Scan the QR code in the OpenClaw mobile app to connect this device.",
      docsLink: "Read the docs →",
      docsTitle: "Docs: ",
    },
    snapshot: {
      channelsHint: "Channel status refreshes on each gateway tick.",
      lastChannelsRefresh: "Last Channels Refresh",
      status: "Status",
      subtitle: "Latest gateway handshake information.",
      tickInterval: "Tick Interval",
    ...
    cards: {
      ...
      recentSessions: "Recent chats",
      tokens: "Tokens",
      modelAuthAttentionExpiredTitle: "Model authentication expired",
      modelAuthAttentionExpiredDesc:
        "{providers} sign-in expired. Reconnect to keep using these models.",
      modelAuthAttentionExpiringTitle: "Model authentication expiring",
      modelAuthAttentionExpiringEntry: "{provider} expires {when}",
    },
    connection: {
      authDocsLink: "Read the docs →",
      authDocsTitle: "Dashboard authentication docs",
      docsHint: "More in the docs:",
      insecureHttpDocsLink: "Allow insecure HTTP →",
      insecureHttpDocsTitle: "Insecure HTTP docs",
      step4: "Or generate a token to paste above:",
      tailscaleDocsLink: "Set up Tailscale →",
      tailscaleDocsTitle: "Tailscale setup docs",
      docsLink: "Read the docs →",
      step1: "Start the gateway on your host machine:",
      step2: "Get a tokenized dashboard URL:",
      step3: "Paste the WebSocket URL and token above, or open the tokenized URL directly.",
