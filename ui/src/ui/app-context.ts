...
import type { RuntimeConfigCapability } from "./controllers/config-capability.ts";
import type { SessionCapability } from "./sessions/index.ts";
import type { WorkboardCapability } from "./controllers/capability.ts";
