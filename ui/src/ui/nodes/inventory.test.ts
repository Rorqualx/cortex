...
describe("findGatewayPresence", () => {
  it("returns the Gateway self beacon", () => {
    const gateway = { instanceId: "gateway-1", mode: " GATEWAY ", ts: 1_000 };
...
describe("listUnpairedPresence", () => {
  it("returns only live beacons with no inventory row", () => {
    ...
    const gateway = { instanceId: "gateway-1", mode: "gateway", ts: 1_000 };
    const disconnected = { instanceId: "left-1", mode: "webchat", reason: "disconnect", ts: 1_000 };
    const textOnly = { text: "note from test", ts: 1_000 };
    const live = { instanceId: "webchat-1", mode: "webchat", host: "browser", ts: 1_000 };
