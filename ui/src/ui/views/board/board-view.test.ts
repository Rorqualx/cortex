...
import type { BoardSnapshot } from "../../board/types.ts";
import type { BoardViewWidget } from "../../board/view-types.ts";
import { recordBoardWidgetTicketReceipt } from "../../board/widget-ticket-lifetime.ts";
