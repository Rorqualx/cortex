...
import type { GatewayBrowserClient, GatewayControlUiPluginTab } from "../gateway.ts";
import type { RouteId } from "../app-route-paths.ts";
import { applicationContext, type ApplicationContext } from "../app-context.ts";
import { hasOperatorApprovalsAccess } from "../app-settings.ts";
import { t } from "../../i18n/index.ts";
import { resolveEmbedSandbox } from "../embed-sandbox.ts";
