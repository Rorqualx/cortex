...
async function loadSourceLocaleMap(): Promise<TranslationMap> {
  return await loadControlUiSourceCatalog(SOURCE_LOCALE_PATH, SESSION_PLACEMENT_SOURCE_LOCALE_PATH);
}

async function readSourceLocaleRaw(): Promise<string> {
  return await readControlUiSourceCatalog(SOURCE_LOCALE_PATH, SESSION_PLACEMENT_SOURCE_LOCALE_PATH);
}
