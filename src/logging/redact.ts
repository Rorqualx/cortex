...
export function redactSensitiveText(text: string, options?: RedactOptions): string {
  ...
  // ENHANCE-OURS: keep our dynamic-secret `scrubbed` input; adopt upstream's
  // redactFormBodies option.
  return redactText(scrubbed, resolved.patterns, { redactFormBodies: resolved.redactFormBodies });
}
