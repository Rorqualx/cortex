...
async function archivePreviousSessionTranscript(params: {
  ...
  // Fork: reply-session rollover rotates the old session out from under an open
  // tab; keep dashboard conversations discoverable as a "Previous:" entry. The
  // helper self-gates to dashboard keys, matching performGatewaySessionReset.
