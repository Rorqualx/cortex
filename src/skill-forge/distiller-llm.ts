...
- Do NOT copy verbatim blocks, banners, or code fragments from existing skills; write the workflow fresh from the candidate data only (EVOMAL counter-prompt).
