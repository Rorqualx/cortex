...
const SHORT_WINDOW_RATE_LIMIT_RE =
  // Fork: "rate limit reached for requests" is Z.ai's coding-plan concurrency 429
  // (code "1302") — a short-window signal, so back off and retry the same model
  // instead of failing over on a transient concurrency spike.
