...
export async function runWithModelFallback<T>(
  ...
  // When every candidate failed but a classifier preserved a partial result,
  // return it as an exhausted outcome instead of throwing. mergeExhaustedResult
  // lets the caller fold the latest attempt's result into the preferred one.
  if (exhaustionResult) {
