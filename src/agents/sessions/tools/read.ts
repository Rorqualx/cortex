        ...
        void (async () => {
          try {
            ...
            if (mimeType) {
              ...
              // normalization, keep our session-ledger recording (read-before-edit
              // + unchanged-repeat).
              const decodedText =
              ...
              // and normalizes CRLF so line splitting is consistent.
              const textContent = (
              ...
              // (Fork feature; the line selection below is upstream's loop.)
