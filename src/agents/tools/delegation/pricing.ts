...
const PRICES: Record<string, ModelPrice> = {
  ...
  // deepseek-v4-flash is retired (silently served by V4.1-Flash); rate kept
  // for historical logs. deepseek-flash serves at the same Flash pricing.
  ...
  "kimi:kimi-k2.5": { input: 0.44, output: 2.0 },
  "kimi:kimi-k2-thinking": { input: 0.6, cachedInput: 0.15, output: 2.5 },
  "kimi:kimi-k2-thinking-turbo": { input: 1.15, cachedInput: 0.15, output: 8.0 },
  ...
  "kimi:kimi-k2-turbo-preview": { input: 1.15, cachedInput: 0.15, output: 8.0 },
  "kimi:moonshot-v1-8k": { input: 0.2, output: 2.0 },
  "kimi:moonshot-v1-32k": { input: 1.0, output: 3.0 },
  "kimi:moonshot-v1-128k": { input: 2.0, output: 5.0 },
  "kimi:moonshot-v1-8k-vision-preview": { input: 0.2, output: 2.0 },
  "kimi:moonshot-v1-32k-vision-preview": { input: 1.0, output: 3.0 },
  "kimi:moonshot-v1-128k-vision-preview": { input: 2.0, output: 5.0 },
};
