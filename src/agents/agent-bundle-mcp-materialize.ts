...
function toAgentToolResult(params: {
  ...
  // Fork: MCP servers are untrusted. Project once through the shared boundary helper,
  // then fence every model-facing text block and sanitize the structured details channel
  // so server output cannot forge tool calls or corrupt downstream structured merging.
  const projected = projectMcpCallToolResult(params.result, {
