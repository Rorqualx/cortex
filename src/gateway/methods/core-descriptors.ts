...
const CORE_GATEWAY_METHOD_SPECS = [
  ...
  // method ordering stays untouched.
  ["activity.list", "activity", "operator.read", "<=2026.7"],
  ["activity.subscribe", "activity", "operator.read", "<=2026.7"],
  ["activity.unsubscribe", "activity", "operator.read", "<=2026.7"],
  ["vault.list", "vault", "operator.read", "<=2026.7"],
  ["vault.save", "vault", "operator.admin", "<=2026.7"],
  ["vault.delete", "vault", "operator.admin", "<=2026.7"],
  ["chat.branch", "chat-branch", "operator.write", "<=2026.7", { startup: true }],
  ["chat.branches", "chat-branch", "operator.read", "<=2026.7", { startup: true }],
  ["doctor.memory.l3Layers", "doctor", "operator.read", "<=2026.7"],
  ["workboard.cards.list", null, "operator.read", "<=2026.7"],
  ["workboard.cards.read", null, "operator.read", "<=2026.7"],
  ["workboard.cards.stats", null, "operator.read", "<=2026.7"],
  ["workboard.cards.runs", null, "operator.read", "<=2026.7"],
  ["workboard.cards.create", null, "operator.write", "<=2026.7"],
  ["workboard.cards.update", null, "operator.write", "<=2026.7"],
  ["workboard.cards.move", null, "operator.write", "<=2026.7"],
  ["workboard.cards.delete", null, "operator.write", "<=2026.7"],
  ["workboard.cards.specify", null, "operator.write", "<=2026.7"],
  ["workboard.cards.decompose", null, "operator.write", "<=2026.7"],
  ["workboard.cards.claim", null, "operator.write", "<=2026.7"],
  ["workboard.cards.release", null, "operator.write", "<=2026.7"],
  ["workboard.cards.heartbeat", null, "operator.write", "<=2026.7"],
  ["workboard.cards.complete", null, "operator.write", "<=2026.7"],
  ["workboard.cards.block", null, "operator.write", "<=2026.7"],
  ["workboard.cards.unblock", null, "operator.write", "<=2026.7"],
  ["workboard.cards.promote", null, "operator.write", "<=2026.7"],
  ["workboard.cards.reassign", null, "operator.write", "<=2026.7"],
  ["workboard.cards.reclaim", null, "operator.write", "<=2026.7"],
  ["workboard.cards.dispatch", null, "operator.write", "<=2026.7"],
  ["workboard.boards.list", null, "operator.read", "<=2026.7"],
  ["workboard.boards.create", null, "operator.write", "<=2026.7"],
  ["workboard.boards.archive", null, "operator.write", "<=2026.7"],
  ["workboard.boards.delete", null, "operator.write", "<=2026.7"],
  ["workboard.research.reports", null, "operator.read", "<=2026.7"],
  ["workboard.research.sync", null, "operator.write", "<=2026.7"],
  ["workboard.research.stage", null, "operator.write", "<=2026.7"],
  ["skills.forge.status", "skills", "operator.read", "<=2026.7"],
  ...
  ["claws.monitors", "claws-monitors", "operator.admin", "2026.9", { controlPlaneWrite: true }],
