...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "activity.list", scope: "operator.read" },
  { name: "activity.subscribe", scope: "operator.read" },
  { name: "activity.unsubscribe", scope: "operator.read" },
  ...
  { name: "skills.forge.status", scope: "operator.read" },
  { name: "skills.forge.run", scope: "operator.admin" },
  { name: "skills.forge.promote", scope: "operator.admin" },
  { name: "skills.forge.retire", scope: "operator.admin" },
  { name: "skills.forge.telemetry", scope: "operator.read" },
  ...
  { name: "vault.list", scope: "operator.read" },
  { name: "vault.save", scope: "operator.admin" },
  { name: "vault.delete", scope: "operator.admin" },
  ...
  { name: "gateway.auth.token.get", scope: "operator.admin" },
  ...
  { name: "chat.branch", scope: "operator.write", startup: true },
  { name: "chat.branches", scope: "operator.read", startup: true },
  ...
  { name: "workboard.cards.move", scope: "operator.write" },
] as const;
