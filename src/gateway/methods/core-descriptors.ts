...
const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "cron.add", scope: "operator.admin", since: "<=2026.7", controlPlaneWrite: true },
  { name: "cron.update", scope: "operator.admin", since: "<=2026.7", controlPlaneWrite: true },
  { name: "cron.remove", scope: "operator.admin", since: "<=2026.7", controlPlaneWrite: true },
  { name: "cron.run", scope: "operator.admin", since: "<=2026.7", controlPlaneWrite: true },
