...
const CORE_GATEWAY_HANDLER_MODULES = {
  ...
  // Fork (cortex) handler groups kept as first-class families.
  activity: () => import("./server-methods/activity.js").then((module) => module.activityHandlers),
  "chat-branch": () =>
    import("./server-methods/chat-branch.js").then((module) => module.chatBranchHandlers),
  vault: () => import("./server-methods/vault.js").then((module) => module.vaultHandlers),
