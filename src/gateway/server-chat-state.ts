...
export type ChatRunState = {
  ...
  /** Accumulated thinking content per run, for inclusion in chat delta events (fork Feature C). */
  thinkingBuffers: Map<string, string>;
  /** Last thinking content broadcast, for computing deltaThinking (fork Feature C). */
