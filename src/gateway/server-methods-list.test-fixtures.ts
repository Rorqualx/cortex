...
activity.list activity.subscribe activity.unsubscribe vault.list vault.save vault.delete chat.branch
chat.branches doctor.memory.l3Layers workboard.cards.list workboard.cards.read workboard.cards.stats
workboard.cards.runs workboard.cards.create workboard.cards.update workboard.cards.move
workboard.cards.delete workboard.cards.specify workboard.cards.decompose workboard.cards.claim
workboard.cards.release workboard.cards.heartbeat workboard.cards.complete workboard.cards.block
workboard.cards.unblock workboard.cards.promote workboard.cards.reassign workboard.cards.reclaim
workboard.cards.dispatch workboard.boards.list workboard.boards.create workboard.boards.archive
workboard.boards.delete workboard.research.reports workboard.research.sync workboard.research.stage
skills.forge.status skills.forge.run skills.forge.promote skills.forge.retire skills.forge.telemetry
`
  .trim()
  .split(/\s+/u);
