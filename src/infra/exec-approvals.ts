...
// KEEP-OURS: alias to the wire contract (single source of truth). The merged
// wire schema already carries every field upstream's explicit type listed
// (commandAnalysis, commandSpans, turnSource*, unavailableDecisions, ...).
