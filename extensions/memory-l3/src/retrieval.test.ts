    ...
    const result = formatMemorySection([
      {
        ...
        score: 0.85,
        signals: { lexical: 1, bm25: 0, importance: 0.7, recency: 1, l3Boost: 0 },
        chunkId: "chunk-1",
        tier: "l2",
      },
    ]);
    ...
    const result = formatMemorySection([
      {
        ...
        score: 0.9,
        signals: { lexical: 1, bm25: 0, importance: 0.8, recency: 1, l3Boost: 0 },
        chunkId: "longterm",
        tier: "longterm",
      },
      {
        ...
        score: 0.5,
        signals: { lexical: 0.5, bm25: 0, importance: 0.6, recency: 1, l3Boost: 0 },
        chunkId: "chunk-1",
        tier: "l2",
      },
    ]);
      ...
      [
        {
          ...
          score: 0.8,
          signals: { lexical: 0.5, bm25: 0, importance: 0.7, recency: 1, l3Boost: 0 },
          chunkId: "chunk-1",
          tier: "l2",
        },
        {
          ...
          score: 0.5,
          signals: { lexical: 0.4, bm25: 0, importance: 0.6, recency: 0.05, l3Boost: 0 },
          chunkId: "chunk-2",
          tier: "l2",
        },
      ],
    ...
    const result = formatMemorySection([
      {
        ...
        score: 0.78,
        signals: { lexical: 0.5, bm25: 0, importance: 0.9, recency: 1, l3Boost: 0 },
        chunkId: "chunk-1",
        tier: "typed",
      },
    ]);
    ...
    const result = formatMemorySection([
      {
        ...
        score: 0.82,
        signals: { lexical: 0.5, bm25: 0, importance: 0.95, recency: 1, l3Boost: 0 },
