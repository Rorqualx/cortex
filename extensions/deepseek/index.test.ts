...
describe("deepseek provider plugin", () => {
  ...
  it.each(["deepseek-v4-flash", "deepseek-v4-pro", "deepseek-v4-flash-vision-exp"])(
    ...
    async (modelId) => {
      ...
      // Fork: xhigh passes through instead of collapsing to max (verified live
      // against api.deepseek.com; see stream.ts resolveDeepSeekReasoningEffort).
      ...
      // Fork: low is no longer promoted to high.
